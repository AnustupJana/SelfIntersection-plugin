...
## License
This plugin is licensed under the **GNU General Public License v2.0 or later**. See the [LICENSE](https://github.com/AnustupJana/SelfIntersection-plugin/blob/main/LICENSE) file for details.
